...
import 'package:flnexpense/pages/main/main_page.dart';
import 'package:flnexpense/pages/personal/personal_page.dart';
import 'package:flnexpense/pages/statistics/statistics_page.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            centerTitle: true,
            title: Text(switch (currentIndex.value) { 2 => "Thống kê", _ => "FlnExpense" },
                style: title1)),
        body: [const MainPage(), const PersonalPage(), const StatisticsPage()][currentIndex.value],
        drawer: Drawer(
            child: Stack(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  ListTile(
                      ...
                      tileColor: currentIndex.value == 0 ? green100.withOpacity(0.2) : null,
                  ...
                  ListTile(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      tileColor: currentIndex.value == 1 ? green100.withOpacity(0.2) : null,
                  ...
                  ListTile(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      tileColor: currentIndex.value == 2 ? green100.withOpacity(0.2) : null,
